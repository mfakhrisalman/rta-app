          ...
          <div class="row">
            <div class="col-sm-5 px-0 d-none d-lg-block ">
                  <div class="card mw-100 mb-3 mh-100" style="background-color: #013A67; border-radius: 16px; height:725px; width: 607px; margin: 10px 5px 15px 20px;">
                    ...
                    <div class="card mw-100 mb-3 mh-100" style="background-color:white; border-radius: 16px; width:90%; margin: auto;">
                      <img src="img/logo_daftar.png" alt="Al-Quran" width="20%" class="m-3" style="float: left;">
                      <div style="margin-left: 25%; padding: 20px; margin-top: -120px;">
                          <h3>خَيْرُكُمْ مَنْ تَعَلَّمَ الْقُرْآنَ وَعَلَّمَهُ</h3>
                          <p class="text-black-50">Sebaik-baik kalian adalah orang yang mempelajari Al-Qur’an dan mengajarkannya” (HR. Bukhori).</p>
                      </div>
                  </div>
                 </div>
              </div>
