$(document).ready(function () {
  ...
  if ($("#kritiksaran-list-datatable").length > 0) {
    usersTable = $("#kritiksaran-list-datatable").DataTable({
      responsive: true,
      'columnDefs': [{
        "orderable": true,
        // "targets": [0, 6, 7]
  ...
  // if ($("#kelas-list-datatable").length > 0) {
  //   usersTable = $("#kelas-list-datatable").DataTable({
  //     responsive: true,
  //     'columnDefs': [{
  //       "orderable": false,
  //       "targets": [0,5,6]
